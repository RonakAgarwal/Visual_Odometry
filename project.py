...
for i in range(10):
    ...
    img_current_frame = cv2.imread(imported_image)
    img_next_frame = cv2.imread(imported_image_next)
    ...
    curr_undistort = UndistortImage(color_img, LUT)
    next_undistort = UndistortImage(color_img_next, LUT)

    sift = cv2.xfeatures2d.SIFT_create()

    kp1, des1 = sift.detectAndCompute(curr_undistort,None)
    kp2, des2 = sift.detectAndCompute(next_undistort,None)
